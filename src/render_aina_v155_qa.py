#!/usr/bin/env python3
"""Render actual AINA v15.5 mesh with corrected reference camera calibration."""
import argparse
...
def main():
    ...
    for yaw,label in views:
        p=args.out/f'AINA_VTK_{label}_v15.5.png';render_vtk(args.clay,p,yaw);paths.append((yaw,label,p))
    ...
    sheet.save(args.out/'AINA_VTK_CALIBRATED_8VIEW_v15.5.png')
    compare(args.front,args.out/'AINA_VTK_front_v15.5.png',args.out/'AINA_REFERENCE_VS_VTK_FRONT_v15.5.png')
    compare(args.q3,args.out/'AINA_VTK_q3_20_primary_v15.5.png',args.out/'AINA_REFERENCE_3Q_VS_VTK_Q3_20_v15.5.png')
    compare(args.side,args.out/'AINA_VTK_left_facing_profile_v15.5.png',args.out/'AINA_REFERENCE_SIDE_VS_VTK_PROFILE_CORRECT_v15.5.png')
    ...
    for yaw,label in [(-15,'q3_15'),(-20,'q3_20_primary'),(-25,'q3_25')]:
        qims.append(Image.open(args.out/f'AINA_VTK_{label}_v15.5.png').convert('RGB'))
    ...
    s.save(args.out/'AINA_REFERENCE_3Q_YAW_SWEEP_v15.5.png')
